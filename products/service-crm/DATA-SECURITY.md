...
## 0. AI exposure: the short answer is NONE
...
There is no automated bulk-delete (deliberately, because auto-wiping financial records is risky).
...
## 6. Buyer guidance (put a short version in the delivery guide / listing)
